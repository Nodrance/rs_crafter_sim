...
0.1. Install cmake or clang or whatever so that you can build highs (the solver I'm using) from source. Just install whatever it complains about missing when you try to build the project, and then try again until it works. Alternatively change cargo.toml from "highs" to "minilp".
